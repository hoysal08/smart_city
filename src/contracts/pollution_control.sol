...
contract PolutionCertificate is ERC721URIStorage {
    ...
    function generateCertificate(uint256 tokenId)
        public
        returns (string memory)
    {
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="25%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Vehicle Number: ",
            getVehicleNo(tokenId),
            "</text>",
            '<text x="50%" y="32%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Type of Vehicle: ",
            getTypeofvehicle(tokenId),
            "</text>",
            '<text x="50%" y="39%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Fuel Type: ",
            getFuelType(tokenId),
            "</text>",
            '<text x="50%" y="46%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Vehicle Model: ",
            getVehicleModel(tokenId),
            "</text>",
            '<text x="50%" y="53%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Vehicle Rating: ",
            getRating(tokenId),
            "</text>",
            '<text x="50%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Vehicle Owner: ",
            getOwnername(tokenId),
            "</text>",
            '<text x="50%" y="67%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Certified At: ",
            getCertifiedAt(tokenId),
            "</text>",
            '<text x="50%" y="74%" class="base" dominant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Valid Till: ",
            getValidTill(tokenId),
            "</text>",
            '<text x="50%" y="81%" class="base" dominredant-baseline="middle" text-anchor="middle" font-size="8px" font-weight="bold">',
            "Validity: ",
            getValidity(tokenId),
            "</text>",
            "</svg>"
    ...
    function getTypeofvehicle(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getVehicleModel(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getCertifiedAt(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getTokenURI(uint256 tokenId) public returns (string memory) {
        bytes memory dataURI = abi.encodePacked(
            "{",
            '"name": "Pollution under certificate #',
            tokenId.toString(),
            '",',
            '"description": "Details of validity of certificate ",',
            '"image": "',
            generateCertificate(tokenId),
            '"',
            ' "valid": "',
            getValidity(tokenId),
            '"',
    ...
    function renew(uint256 tokenId, uint256 _rating) public {
        require(_exists(tokenId), "Please use an existing Token");
        require(
            block.timestamp < tokenidtoCerf[tokenId].ValidTill - 15 days,
            "you can renew only with validity less than 15 days"
        );
